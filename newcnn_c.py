...
# Initialize empty lists fr image paths and labels
image_paths = []
labels = []
...
cnn_model.save('D:\\MY PROJECT\\data preprocessing\\newcnn_c.h5')

new_image_path = r"D:\MY PROJECT\data preprocessing\test\abnormal\HB(232).jpg"
